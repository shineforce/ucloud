...
{
    $UCLOUD_PUBLIC_KEY = config('ucloud.UCLOUD_PUBLIC_KEY');
    $UCLOUD_PRIVATE_KEY = config('ucloud.UCLOUD_PRIVATE_KEY');
    $UCLOUD_PROXY_SUFFIX = config('ucloud.UCLOUD_PROXY_SUFFIX');
